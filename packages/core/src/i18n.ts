...
export interface Dict {
  ...
  historyTitle: string; historySub: string; fullHistory: string; noHistory: string; historyN: string; hCreated: string; hDone: string; hReopened: string; hArchived: string; hRestored: string; hTitle: string; hNote: string; hProject: string; hTags: string; hEdited: string; hCleared: string; hBumped: string; hCommentRemoved: string; hRemoved: string; hSrcTemplate: string; hSrcCalendar: string; hSrcRecur: string; hSrcCapture: string; historyHint: string; hPick: string; hRecent: string; hOpenTask: string; hAllTasks: string;
...
export const EN: Dict = {
  ...
  historyTitle: 'History', historySub: 'every change to this task, newest first', fullHistory: 'Full history', noHistory: 'No changes recorded yet.', historyN: 'changes', hCreated: 'Created', hDone: 'Completed', hReopened: 'Reopened', hArchived: 'Archived', hRestored: 'Restored', hTitle: 'Title', hNote: 'Note', hProject: 'Project', hTags: 'Tags', hEdited: 'edited', hCleared: 'cleared', hBumped: 'idle counter reset', hCommentRemoved: 'comment removed', hRemoved: 'removed: ', hSrcTemplate: 'from template', hSrcCalendar: 'via Google Calendar', hSrcRecur: 'next occurrence', hSrcCapture: 'from capture', historyHint: 'Changes are recorded on this device and synced with the task. Up to 200 entries are kept.', hPick: 'Pick a task on the left to see its timeline.', hRecent: 'Recently changed', hOpenTask: 'Open task', hAllTasks: 'All tasks',
