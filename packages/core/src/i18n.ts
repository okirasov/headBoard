...
export interface Dict {
  ...
  welcomeKicker: string; welcomeTitle: string; welcomeSub: string; welcome1: string; welcome1Sub: string; welcome2: string; welcome2Sub: string; welcome3: string; welcome3Sub: string; welcomeCapture: string; welcomeTemplates: string; welcomeShortcut: string;
  dataTitle: string; exportData: string; importData: string; exportHint: string; tImported: string; tImportBad: string; dangerTitle: string; deleteAccount: string; deleteAccountHint: string; deleteAccountConfirm: string; deleteAccountBusy: string; tAccountDeleted: string; tAccountDeleteFailed: string;
  apiUrlLbl: string; apiUrlHint: string; apiUrlSaved: string;
...
export const EN: Dict = {
  ...
  gcalConnect: 'Connect Google Calendar', gcalConnected: 'Google Calendar · two-way sync', gcalSyncing: 'syncing…', gcalSyncNow: 'Sync now', gcalDisconnect: 'Disconnect', gcalError: 'Google Calendar · sync error', gcalReauth: 'Google Calendar · reconnect needed', gcalUnavailable: 'Google Calendar · not configured', gcalDenied: 'Calendar access was not granted', gcalHint: 'Tasks with a due date appear as all-day events in a “Deboard” calendar. Moves, renames and new events sync back.', gcalSynced: 'synced ',
  ...
  welcomeKicker: 'Welcome', welcomeTitle: 'Your board is empty — good place to start.', welcomeSub: 'Deboard is a place to unload your head: drop thoughts in, let the board sort them into Inbox, Focus and Waiting, and let Review bring back what you forgot.', welcome1: 'Capture', welcome1Sub: 'Paste anything — notes, a meeting dump, a list. It becomes tasks with priority, tags and project.', welcome2: 'Work the board', welcome2Sub: 'Drag between columns, set a due date, snooze what can wait. Forgotten cards float up on their own.', welcome3: 'Review and digest', welcome3Sub: 'Every morning a short digest; Review shows what went quiet so you can keep, snooze or drop it.', welcomeCapture: 'Capture your first thoughts', welcomeTemplates: 'Start from a template', welcomeShortcut: 'press c to capture · ? for shortcuts',
  dataTitle: 'Your data', exportData: 'Export', importData: 'Import', exportHint: 'Tasks, projects and templates with their history. Attachments are listed by name; file contents stay on the server.', tImported: 'Imported — added: ', tImportBad: 'Not a Deboard backup', dangerTitle: 'Danger zone', deleteAccount: 'Delete account', deleteAccountHint: 'Removes the account and everything in it on the server: tasks, comments, files, projects, templates, settings, calendar link and devices. This cannot be undone.', deleteAccountConfirm: 'Yes, delete everything', deleteAccountBusy: 'Deleting…', tAccountDeleted: 'Account deleted', tAccountDeleteFailed: 'Could not delete the account — try again',
  apiUrlLbl: 'Server', apiUrlHint: 'Address of the API; the default is the hosted server, a Mac on the same Wi-Fi works too: http://192.168.1.38:5081', apiUrlSaved: 'Server address saved',
...
export const RU: Dict = {
  ...
  gcalConnect: 'Подключить Google Calendar', gcalConnected: 'Google Calendar · двусторонняя синхронизация', gcalSyncing: 'синхронизация…', gcalSyncNow: 'Синхронизировать', gcalDisconnect: 'Отключить', gcalError: 'Google Calendar · ошибка синхронизации', gcalReauth: 'Google Calendar · нужно переподключить', gcalUnavailable: 'Google Calendar · не настроен', gcalDenied: 'Доступ к календарю не выдан', gcalHint: 'Задачи со сроком появляются событиями на весь день в календаре «Deboard». Переносы, переименования и новые события возвращаются на доску.', gcalSynced: 'синхронизировано ',
  ...
  welcomeKicker: 'Добро пожаловать', welcomeTitle: 'Доска пуста — самое время начать.', welcomeSub: 'Deboard разгружает голову: сбрасывайте мысли, доска раскладывает их по Инбоксу, Фокусу и Ожиданию, а «Разбор» возвращает то, что вы забыли.', welcome1: 'Захват', welcome1Sub: 'Вставьте что угодно: заметки, итоги встречи, список. Это станет задачами с приоритетом, тегами и проектом.', welcome2: 'Работайте с доской', welcome2Sub: 'Перетаскивайте между колонками, ставьте срок, откладывайте то, что может подождать. Забытые карточки всплывают сами.', welcome3: 'Разбор и дайджест', welcome3Sub: 'Каждое утро короткий дайджест; «Разбор» показывает, что затихло, чтобы оставить, отложить или отпустить.', welcomeCapture: 'Записать первые мысли', welcomeTemplates: 'Начать с шаблона', welcomeShortcut: 'c — захват · ? — горячие клавиши',
  dataTitle: 'Ваши данные', exportData: 'Экспорт', importData: 'Импорт', exportHint: 'Задачи, проекты и шаблоны с историей. Вложения перечислены по имени; содержимое файлов остаётся на сервере.', tImported: 'Импортировано — добавлено: ', tImportBad: 'Это не резервная копия Deboard', dangerTitle: 'Опасная зона', deleteAccount: 'Удалить аккаунт', deleteAccountHint: 'Удаляет аккаунт и всё, что в нём, на сервере: задачи, комментарии, файлы, проекты, шаблоны, настройки, связь с календарём и устройства. Отменить нельзя.', deleteAccountConfirm: 'Да, удалить всё', deleteAccountBusy: 'Удаляем…', tAccountDeleted: 'Аккаунт удалён', tAccountDeleteFailed: 'Не удалось удалить аккаунт — попробуйте ещё раз',
  apiUrlLbl: 'Сервер', apiUrlHint: 'Адрес API; по умолчанию сервер в облаке, подойдёт и Mac в той же Wi-Fi сети: http://192.168.1.38:5081', apiUrlSaved: 'Адрес сервера сохранён',
