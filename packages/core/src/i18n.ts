...
export const EN: Dict = {
  ...
  apiUrlLbl: 'Server', apiUrlHint: 'Address of the API, e.g. the Mac on the same Wi-Fi: http://192.168.1.38:5081', apiUrlSaved: 'Server address saved',
...
export const RU: Dict = {
  ...
  apiUrlLbl: 'Сервер', apiUrlHint: 'Адрес API, например Mac в той же Wi-Fi сети: http://192.168.1.38:5081', apiUrlSaved: 'Адрес сервера сохранён',
