...
export const IcTemplate = ({ size = 16, color }: P) => (
  <Svg width={size} height={size} viewBox="0 0 16 16" fill="none"><Rect x="2.5" y="2" width="11" height="12" rx="1.5" stroke={color} strokeWidth="1.5" /><Path d="M5 5.5h6M5 8.5h6M5 11.5h3" stroke={color} strokeWidth="1.5" {...R} /><Path d="M10.5 10.5l1 1 2-2" stroke={color} strokeWidth="1.5" {...R} /></Svg>
);
...
export const IcRepeat = ({ size = 16, color }: P) => (
  <Svg width={size} height={size} viewBox="0 0 16 16" fill="none"><Path d="M13.5 7A5.5 5.5 0 0 0 3.3 4.6M2.5 9a5.5 5.5 0 0 0 10.2 2.4" stroke={color} strokeWidth="1.5" {...R} /><Path d="M13.5 2.5V7H9M2.5 13.5V9h4.5" stroke={color} strokeWidth="1.5" {...R} /></Svg>
);
export const IcBell = ({ size = 16, color }: P) => (
  <Svg width={size} height={size} viewBox="0 0 16 16" fill="none"><Path d="M4 11V7.5a4 4 0 0 1 8 0V11l1 1.5H3z" stroke={color} strokeWidth="1.5" {...R} /><Path d="M6.5 14a1.5 1.5 0 0 0 3 0" stroke={color} strokeWidth="1.5" {...R} /></Svg>
);
export const IcSearch = ({ size = 16, color }: P) => (
  <Svg width={size} height={size} viewBox="0 0 16 16" fill="none"><Circle cx="7" cy="7" r="5" stroke={color} strokeWidth="1.6" /><Path d="M11 11l3.4 3.4" stroke={color} strokeWidth="1.6" {...R} /></Svg>
);
