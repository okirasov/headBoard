...
export default {
  ...
  theme: {
    ...
    spacing: { px: '1px', ...px(...Array.from({ length: 65 }, (_, i) => i)), ...px(0.5, 1.5, 2.5, 4.5, 80, 90, 96, 110, 120, 130, 132, 150, 186, 200, 234, 250, 280, 290, 322, 380, 392, 432, 460, 470, 520, 600, 730, 760, 820, 1080) },
